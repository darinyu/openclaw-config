...
const SCOPES_READWRITE = [
  ...
  'https://www.googleapis.com/auth/gmail.modify',       // Read/write/modify Gmail
  ...
  'https://www.googleapis.com/auth/drive.readonly',       // Google Drive read-only (search/list files)
];
